...
**💡 小贴士**: 使用 `cat` 命令查看文件，或直接在 GitHub 上阅读！
...
|------|-------|------|--------|----------|
| **Auto-Research** | ~76.0k | Karpathy最新，AI自主研究 | [karpathy/autoresearch](https://github.com/karpathy/autoresearch) | ⭐⭐⭐⭐⭐ |
| **MiroFish** | ~57.0k | 群体智能引擎，预测万物 | [666ghj/MiroFish](https://github.com/666ghj/MiroFish) | ⭐⭐⭐⭐⭐ |
| **LangGraph** | ~30.2k | 图结构工作流编排 | [langchain-ai/langgraph](https://github.com/langchain-ai/langgraph) | ⭐⭐⭐⭐⭐ |
| **GPT Researcher** | ~26.6k | 自主研究Agent | [assafelovic/gpt-researcher](https://github.com/assafelovic/gpt-researcher) | ⭐⭐⭐⭐ |
| **Swarm** | ~21.3k | OpenAI多智能体协作 | [openai/swarm](https://github.com/openai/swarm) | ⭐⭐⭐⭐⭐ |
| **OpenViking** | ~22.9k | 分层记忆系统 | [volcengine/OpenViking](https://github.com/volcengine/OpenViking) | ⭐⭐⭐⭐ |
| **MAS Factory** | ~362 | Vibe Graphing | [BUPT-GAMMA/MASFactory](https://github.com/BUPT-GAMMA/MASFactory) | ⭐⭐⭐⭐ |
| **Cherry Studio** | ~37 | AI客户端 | [kangfenmao/cherry-studio](https://github.com/kangfenmao/cherry-studio) | ⭐⭐⭐ |
...
- **GitHub Issues**: [提交问题](https://github.com/srxly888-creator/ai-agent-learning-hub/issues)
- **GitHub Discussions**: [参与讨论](https://github.com/srxly888-creator/ai-agent-learning-hub/discussions)
...
感谢所有开源项目的贡献者，你们让 AI Agent 生态更加丰富！
